...
Tabs.InterfaceSettings:CreateButton({
    ...
    Callback = function()
        Rayfield:Destroy()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/theystemYT/theystems-Menu/refs/heads/main/theystem's%20Menu%20(Fluent%20Interface%20Suite).lua"))()
    end
})
...
Tabs.Contributions:CreateLabel("Do you have changes that you would like to be added to theystem's Menu? Well, if yes, click on the button below to copy the link for the Google Form to submit your changes.", "circle-alert")
