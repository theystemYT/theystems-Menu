...
Converted["_Open"].Text = "Triple-click this region to open YARHM UI."
...
Converted["_HubName"].Text = "theystem's Menu"
...
Converted["_TextLabel3"].Text = "Loading script..."
...
Converted["_TextLabel4"].Text = "YARHM UI Version: 1.19"
...
Converted["_TextLabel5"].Text = "YARHM UI"
...
local function NFLXNSA_fake_script() -- Fake Script: StarterGui.YARHM.Init
	...
	require(script.Parent.FUNCTIONS).notification("Welcome to YARHM Nebula. (Executed with theystem's Menu)")
