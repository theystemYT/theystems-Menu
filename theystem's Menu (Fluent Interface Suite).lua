...
-- Contributions section added at the end

Tabs.Contributions:AddLabel("Contributions")
Tabs.Contributions:AddLabel("Do you have changes that you would like to be added to the system's Menu? Well, if yes, click on the button below to copy the link for the Google Form to submit your changes.")
...
-- Add the contributions stuff before the window select tab.
