...
local Tabs = {
    ...
    Credits = Window:AddTab({ Title = "Credits", Icon = "sparkles" })
}
...
Tabs.Credits:AddParagraph({
    Title = "Credits",
    Content = "Credits to @theystem for creating this script. Click on the button below to get @theystem's YouTube channel link."
})
