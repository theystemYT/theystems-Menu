> [!IMPORTANT]
> I am no longer working on this project. I am now currently working on theystem's Menu V2. You can still use this script, but it will no longer be updated. Thank you for understanding. I recommend you try the new script, available at the [theystem's Menu V2 repository](https://github.com/theystemYT/theystems-Menu-V2).
