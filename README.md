...
To get the script, go into the [theystem's Menu.lua](https://github.com/theystemYT/theystems-Menu/blob/main/theystem's%20Menu.lua) in this repository, and copy the full script, or use the loadstring script below if the script is too long.
```lua
