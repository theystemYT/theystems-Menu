...
To get the script, go into the [theystem's Menu.lua](https://github.com/theystemYT/theystems-Menu/blob/main/theystem's%20Menu.lua) in this repository, and copy the code, or use the loadstring script below.
```lua
